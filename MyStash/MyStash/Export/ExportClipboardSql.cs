...
namespace MyStash.Export
{
    ...
    /// </summary>
    public class ExportClipboardSql<T> : ExportSql<T> 
    {
        /// <summary>
        ...
        {
            throw new EnaxosExportException(AppResources.ExportClipboardSql_ExecuteOutput_no_shell_execute_in_PCL_version);
        }
        ...
        protected override void CloseOutput()
        {
            ...
            switch (Destination)
            {
                ...
                case Destination.Clipboard:
                    CrossShare.Current.SetClipboardText(s, AppResources.ExportClipboardSql_CloseOutput_MyStash_SQL_data);
                    break;
                case Destination.Share:
                    CrossShare.Current.Share(s, AppResources.ExportClipboardSql_CloseOutput_MyStash_SQL_data);
                    break;
            }
        }
    }
